...
/** 인테리어 자동화 공통 설정(유지보수용) */
const INTERIOR_RUNTIME_CONFIG = {
  ANALYSIS_DAYS: 90,
  ALERT_SCHEDULE: '1일1회',
  ARCHIVE_AFTER_DAYS: 30,
  TELEGRAM_BOT_TOKEN_PROPERTY_KEY: 'INTERIOR_TELEGRAM_BOT_TOKEN',
  TELEGRAM_CHAT_ID_PROPERTY_KEY: 'INTERIOR_TELEGRAM_CHAT_ID'
};
